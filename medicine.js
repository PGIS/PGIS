$(document).ready(function() {
    ...
    $('#medicine tbody tr').each(function(indexRow,indexVal) {
        drugs.push({
            "eligible":"#"+$(indexVal,'td:eq(2)').find('.entryselect').attr('id'),
            "available":"#"+$(indexVal,'td:eq(3)').find('.entryselect').attr('id'),
            "notAvailable":["#"+$(indexVal,'td:eq(4)').find('.entryselect').attr('id'),"#"+$(indexVal,'td:eq(5)').find('.entryselect').attr('id'),"#"+$(indexVal,'td:eq(6)').find('.entryselect').attr('id')]
