    ...
    <div>
        <div class="col-md-10 cent">
            <table class="table">
                ...
                <tr> 
                    ...
                    <td>
                       <a href="<?php echo site_url('directorPgis/creating_pdf/'.$userid)?>">Generating admission letter </a> 
                    </td>
                   
                       <?php
                        echo form_open('directorPgis/sendadmission/'.$userid);
       ...
       <div class="col-md-10 cent">
         ...
         <?php if (isset($sent)){
            ...
            <table class="table">
                <?php echo form_open('directorPgis/admit/'.$userid); ?>
                <tr>
