...
<div id="page-wrapper">
    ...
    <div class="col-lg-6">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <table class=" table table-condensed table-striped" id="mytable3">
                                ...
                                <tbody>
                                    <?php 
                                    $res=$this->db->get_where('tb_student_desert',array('registrationID'=>$registration,'ext_status'=>'yes'));
                                    if($res->num_rows()>0){
        ...
        function recentdissertation(reg_id){
            var url="<?php echo site_url('externalSup/details2');?>";
            var url2=url + '/'+reg_id;
    ...
    <div class="col-lg-6">
        ...
        <table class="table table-condensed">
            <?php echo form_open_multipart('externalSup/comment/'.$id);?>
            ...
            <tr><td>Date</td><td><label class="alert-warning"><?php echo form_error('dtz');?></label><input class="form-control datepicker" name="dtz" value="<?php echo date('m/d/Y');?>"></td></tr>
