                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        <li><button class="mybtn btn-primary" style="margin-left: 4px;">
                                <span class="glyphicon glyphicon-dashboard"></span>  HEAD OF DEPARTMENT</button>
                        </li>
                        <li><a href="<?php echo site_url('headDepartment'); ?>"><span class="glyphicon glyphicon-eye-open"></span>
                                Unsigned supervisor</a>
                        </li>
                        <li>    
                            <a href="<?php echo site_url('headDepartment/presentationFeedback'); ?>"><span class="glyphicon glyphicon-retweet"></span>   Presentation Feedback</a>
                        </li>
                         <li>    
