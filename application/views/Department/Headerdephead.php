            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li><a href="<?php echo site_url('headDepartmet'); ?>"><span class="glyphicon glyphicon-eye-open"></span>
                                Unsigned supervisor</a>
                        </li>
                        <li>    
                            <a href="<?php echo site_url('headDepartmet/presentationFeedback'); ?>"><span class="glyphicon glyphicon-retweet"></span> Presentation Feedback</a>
                        </li>
                        <li>    
