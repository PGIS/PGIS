        ...
        <div class="tab-content" style="display: block">
            <div class="in tab-pane active">
                    ...
                    <div class="modal-dialog modal-md">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <?php echo form_open('headDepartmet/record_entry/'.$id,array('id'=>'ajax'));?>
                                ...
                                <tbody>
                                    ...
                                    <?php if(isset($teach)){
                                      foreach ($teach->result() as $row){
                                          ...
                                          echo '<tr><td><input type="radio" name="assign" class="form-control" value="'.$row->email.'"></td><td>'.$row->fullName.'</td><td>'.$row->email.'</td><td><label class="btn btn-warning btn-xs">'.anchor('headDepartmet/update/'.$row->id,'Details',array('data-target'=>'#details','data-toggle'=>'modal')).'</label></td></tr>';
                                      }
                                      }
                                    }?>
               ...
               $('#ajax').submit(function(e){
                   ...
                   var url="<?php echo site_url('headDepartmet/record_entry/'.$id);?>";
