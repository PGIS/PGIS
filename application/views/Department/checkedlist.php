    ...
    <div >
        ...
        if(isset($query)){
          ...
          foreach ($query as $row){
                ...
                echo  '<td><a href="'.site_url('department_Coordinator/admit/'.$row->userid).'" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-plus">admission letter</span></a></td>';
                echo '</tr>';
            }
        }
