                        ...
                        <tbody>
                            <?php if(isset($query)){
                              foreach ($query->result() as $row1){
                               echo '<tr><td>'.$row1->id.'</td><td>'.$row1->registration_id.'</td><td>'.$row1->surname.'</td><td>'.$row1->other_name.'</td><td>'.$row1->project_title.'</td><td>'.$row1->Internal_supervisor.'</td><td class="text text-info"><b class="glyphicon glyphicon-ok"></b>assigned</td></tr>';
                              }
                        }
                        ?>
                        </tbody>
