	  ...
	  <a class="navbar-brand hidden-lg" href='#'>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          ...
          <ul class="nav navbar-nav side-nav">
              <li>
                    <button  class="mybtn btn-primary btn-block">
                        INTERNAL EXAMINER
                    </button>
              </li> 
            <li>
                <a href="<?php echo site_url('internal');?>">
                <span class="glyphicon glyphicon-list"></span> Student assigned</a>
            </li>
            <li>
                <a href="<?php echo site_url('internal/feedBack');?>">
                <span class="glyphicon glyphicon-adjust"></span> Final Feedback</a>
            </li>
